...
namespace Bricklayer.Core.Server.World
{
    public class Level : Common.World.Level
    {
        ...
        private void BlockPlaced(int x, int y, int z, Tile tile)
        {
            ...
            Server.Net.Broadcast(this, new BlockPlaceMessage(x, y, z, tile.Type));
            ...
            Server.Events.Game.Level.BlockPlaced.Invoke(new EventManager.GameEvents.LevelEvents.BlockPlacedEventArgs(null, x, y, z, tile.Type));
        }
    }
}
